...
describe('recap share code', () => {
  it('round-trips and carries no truth fields', () => {
    const r = { episodeId: 'mini', timeUsed: 33, watsonCalls: 4, accusations: 1, verdict: 'solved' as const, visited: ['hall', 'galley'], unvisited: ['engine'], order: [{ cardId: 'e_hook', by: 'holmes' as const, at: 15 }] };
